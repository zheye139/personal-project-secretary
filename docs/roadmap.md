...
### M5: Multi-project Management / 多项目管理

- project registry / 项目注册表
- multi-project reports / 多项目报告
- cross-project knowledge retrieval / 跨项目知识检索

### M6: Multimodal and Engineering Data / 多模态与工程资料

- PDF to Markdown / PDF 转 Markdown
- image notes / 图片说明入库
- codebase summary / 代码库摘要
- engineering templates / 工程记录模板

### M7: Hardware and Model Upgrade / 硬件与模型升级

- migrate to a stronger desktop / 迁移到更强台式机
- upgrade LLM / 升级主模型
- add reranker / 增加重排模型
- add vision model / 增加视觉模型
